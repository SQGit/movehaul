...
public class Book_later extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressDialog = new ProgressDialog(Book_later.this, R.style.AppCompatAlertDialogStyle);
        ...
        if (!net.sqindia.movhaul.Config.isConnected(Book_later.this)) {
            snackbar.show();
  ...
  /*  private void truck_type() {
    ...
    class fetch_goods extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String json = "", jsonStr = "";
            try {
                String virtual_url = net.sqindia.movhaul.Config.WEB_URL + "customer/goodstype";
    ...
    class fetch_trucks extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String json = "", jsonStr = "";
            try {
                String virtual_url = net.sqindia.movhaul.Config.WEB_URL + "customer/vehicletype";
                //Log.e("tag","url: "+virtual_url);
                JSONObject jsonobject = HttpUtils.getData(virtual_url, id, token);
                // Log.e("tag_", "0" + jsonobject.toString());
                if (jsonobject.toString() == "sam") {
        ...
        protected String doInBackground(String... strings) {
            ...
            if (goods_imgs.size() > 0) {
                ...
                try {
                    ...
                    HttpPost httppost = new HttpPost(net.sqindia.movhaul.Config.WEB_URL + "customer/booking");
                ...
                try {
                 ...
                 //   jsonObject.put("truck_type", str_truck_type);
                    ...
                    return s = HttpUtils.makeRequest1(net.sqindia.movhaul.Config.WEB_URL + "customer/booking", json, id, token);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                return null;
