...
public class DriversList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!net.sqindia.movhaul.Config.isConnected(DriversList.this)) {
            snackbar.show();
    ...
    public class book_now_task extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                return s = HttpUtils.makeRequest1(net.sqindia.movhaul.Config.WEB_URL + "customer/payment",json,id,token);
            } catch (JSONException e) {
                e.printStackTrace();
            }
            return null;
