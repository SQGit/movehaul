...
public class DriversListAdapter extends ArrayAdapter<String> {
    ...
    Dialog dialog1;
    ImageView btn_close,driver_imagelist;
    Button btn_ok;
    ...
    public View getView(int position, final View convertView, ViewGroup parent) {
       ...
       FontsManager.changeFonts(act);
        ...
        driver_imagelist=(ImageView) cell.findViewById(R.id.imagsdesdView2);
        ...
        driver_imagelist.setOnClickListener(new View.OnClickListener()
        {
            @Override
