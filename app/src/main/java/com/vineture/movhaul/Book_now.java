...
public class Book_now extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.book_now);
        ...
        et_delivery_address = (EditText) findViewById(com.vineture.movhaul.R.id.editTextDelieveryAddress);
        et_goodstype = (EditText) findViewById(com.vineture.movhaul.R.id.editTextGoodsType);
        et_trucktype = (EditText) findViewById(com.vineture.movhaul.R.id.editTextTruck_type);
        et_description = (EditText) findViewById(com.vineture.movhaul.R.id.editTextDescription);
        flt_delivery_address = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_deliveryaddress);
        flt_goodstype = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_goodstype);
        flt_trucktype = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_trucktype);
        flt_description = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_description);

        lt_goodsType = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_goodstype);
        lt_truckType = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_truckType);


        btn_back = (com.rey.material.widget.LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_back);
        btn_post = (Button) findViewById(com.vineture.movhaul.R.id.btn_post);
        ...
        View getImages = findViewById(com.vineture.movhaul.R.id.camera);
        mSelectedImagesContainer = (ViewGroup) findViewById(com.vineture.movhaul.R.id.selected_photos_container);


        fl_goods = (FrameLayout) findViewById(com.vineture.movhaul.R.id.frame_goodstype);
        lt_images = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_photos);
        ...
        snackbar = Snackbar
                .make(findViewById(com.vineture.movhaul.R.id.top), com.vineture.movhaul.R.string.no_internet, Snackbar.LENGTH_LONG);
        ...
        mProgressDialog = new ProgressDialog(Book_now.this, com.vineture.movhaul.R.style.AppCompatAlertDialogStyle);
        ...
        if (!com.vineture.movhaul.Config.isConnected(Book_now.this)) {
            snackbar.show();
            tv_snack.setText(com.vineture.movhaul.R.string.please_try_again);
        } else {
        ...
        if (vec_type.equals("Bus")) {
            et_trucktype.setCompoundDrawablesWithIntrinsicBounds(com.vineture.movhaul.R.drawable.bus_type, 0, 0, 0);
            flt_trucktype.setHint(getString(com.vineture.movhaul.R.string.ad));
            flt_delivery_address.setHint(getString(com.vineture.movhaul.R.string.ava));
            fl_goods.setVisibility(View.GONE);
            lt_images.setVisibility(View.GONE);
        } else if (vec_type.equals("Truck")) {
            et_trucktype.setCompoundDrawablesWithIntrinsicBounds(com.vineture.movhaul.R.drawable.select_truck_type, 0, 0, 0);
            flt_trucktype.setHint(getString(com.vineture.movhaul.R.string.adsf));
            flt_delivery_address.setHint(getString(com.vineture.movhaul.R.string.aev));
               ...
               // if (!(et_delivery_address.getText().toString().trim().isEmpty())) {
                    if (!(et_trucktype.getText().toString().trim().isEmpty()) && !et_trucktype.getText().toString().contains("Bus Type") && !et_trucktype.getText().toString().contains("Truck Type")) {
                            ...
                            if (vec_type.equals("Truck")) {
                                if (!(et_goodstype.getText().toString().trim().isEmpty())) {
                                   ...
                                   // str_desc = et_description.getText().toString();
                                    ...
                                    Toast.makeText(getApplicationContext(), com.vineture.movhaul.R.string.cdaso, Toast.LENGTH_LONG).show();
                                }
                            } else {
                      ...
                      /*  } else {
                        ...
                        Toast.makeText(getApplicationContext(), getString(com.vineture.movhaul.R.string.asda) + vec_type + getString(com.vineture.movhaul.R.string.asdv), Toast.LENGTH_LONG).show();
                    }
               /* } else {
        ...
        dialog1.setContentView(com.vineture.movhaul.R.layout.dialogue_job_posting);
        btn_ok = (Button) dialog1.findViewById(com.vineture.movhaul.R.id.button_ok);
        jobtv1 = (TextView) dialog1.findViewById(com.vineture.movhaul.R.id.textView_1);
        jobtv2 = (TextView) dialog1.findViewById(com.vineture.movhaul.R.id.textView_2);
        jobtv3 = (TextView) dialog1.findViewById(com.vineture.movhaul.R.id.textView_3);
        jobtv4 = (TextView) dialog1.findViewById(com.vineture.movhaul.R.id.textView_4);
        btn_close = (ImageView) dialog1.findViewById(com.vineture.movhaul.R.id.button_close);
    ...
    private void goods_type() {
        ...
        dialog_goodsType.getWindow().setBackgroundDrawable(getResources().getDrawable(com.vineture.movhaul.R.drawable.choose));
        dialog_goodsType.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        dialog_goodsType.getWindow().getAttributes().windowAnimations = com.vineture.movhaul.R.style.MaterialDialogSheetAnimation;
    ...
    private void truck_type(ArrayList<String> ar_truck_typea, HashMap<String, String> hash_subtypea, HashMap<String, String> hash_truck_imgsa, ArrayList<String> ar_truck_sstypea, ArrayList<String> ar_truck_imgsa) {
        ...
        dialog_vehicleType.getWindow().setBackgroundDrawable(getResources().getDrawable(com.vineture.movhaul.R.drawable.choose));
        dialog_vehicleType.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        // dialog_vehicleType.getWindow().getAttributes().height= 120;
        dialog_vehicleType.getWindow().getAttributes().windowAnimations = com.vineture.movhaul.R.style.MaterialDialogSheetAnimation;
    ...
    private void showMedia() {
        ...
        for (i = 0; i < goods_imgs.size(); i++) {
            ...
            final View imageHolder = LayoutInflater.from(this).inflate(com.vineture.movhaul.R.layout.image_item, null);
            final ImageView thumbnail = (ImageView) imageHolder.findViewById(com.vineture.movhaul.R.id.media_image);
    ...
    class fetch_goods extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String json = "", jsonStr = "";
            try {
                String virtual_url = com.vineture.movhaul.Config.WEB_URL + "customer/goodstype";
    ...
    class fetch_trucks extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String json = "", jsonStr = "";
            try {
                String virtual_url = com.vineture.movhaul.Config.WEB_URL + "customer/vehicletype";
                JSONObject jsonobject = HttpUtils.getData(virtual_url, id, token);
                if (jsonobject.toString() == "sam") {
                }
                json = jsonobject.toString();
        ...
        protected String doInBackground(String... strings) {
            ...
            if (goods_imgs.size() > 0) {
                ...
                try {
                    ...
                    HttpPost httppost = new HttpPost(com.vineture.movhaul.Config.WEB_URL + "customer/booking");
                ...
                try {
                    ...
                    return s = HttpUtils.makeRequest1(com.vineture.movhaul.Config.WEB_URL + "customer/booking", json, id, token);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                return null;
            ...
            if (s != null) {
                try {
                    ...
                    if (status.equals("true")) {
                        ...
                        Toast.makeText(getApplicationContext(), com.vineture.movhaul.R.string.no_internet, Toast.LENGTH_LONG).show();
