...
public class Payment_Details1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.payment_details1);
        ...
        tv_payment = (TextView) findViewById(com.vineture.movhaul.R.id.textview_payment);
        ...
        radioGroup = (RadioGroup) findViewById(com.vineture.movhaul.R.id.radioGroup2);
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if(checkedId == com.vineture.movhaul.R.id.r_visa) {

                  payment = "VISA";

                } else if(checkedId == com.vineture.movhaul.R.id.r_verve) {

                    payment = "VERVE";

                } else if(checkedId == com.vineture.movhaul.R.id.r_wallet) {
