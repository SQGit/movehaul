...
public class EmergencyContacts extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.emergency_contacts);
        ...
        tv_emergency_name1 = (TextView) findViewById(com.vineture.movhaul.R.id.textview_emergency_name1);
        tv_emergency_name2 = (TextView) findViewById(com.vineture.movhaul.R.id.textview_emergency_name2);
        tv_emergency_no1 = (TextView) findViewById(com.vineture.movhaul.R.id.textview_emergency_number1);
        tv_emergency_no2 = (TextView) findViewById(com.vineture.movhaul.R.id.textview_emergency_number2);
        tv_emergency_relation1 = (TextView) findViewById(com.vineture.movhaul.R.id.textview_emergency_relation1);
        tv_emergency_relation2 = (TextView) findViewById(com.vineture.movhaul.R.id.textview_emergency_relation2);




        lt_edit = (LinearLayout) findViewById(com.vineture.movhaul.R.id.linear_edit);
        lt_show = (LinearLayout) findViewById(com.vineture.movhaul.R.id.linear_show);

        btn_back = (com.rey.material.widget.LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_back);

        til_name = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.til_name);
        til_phone = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.til_phone);
        til_relation = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.til_relation);
