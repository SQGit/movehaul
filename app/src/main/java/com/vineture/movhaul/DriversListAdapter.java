...
public class DriversListAdapter extends ArrayAdapter<MV_Datas> {
    ...
    public View getView(int position, final View convertView, ViewGroup parent) {
        ...
        if (cell == null) {
            ...
            cell = (FoldingCell) vi.inflate(com.vineture.movhaul.R.layout.drivers_list_adapter, parent, false);
        ...
        if(doid == 0){
            layouts = new int[]{
                    com.vineture.movhaul.R.layout.truck_front,
                    com.vineture.movhaul.R.layout.truck_back,};
        }
        else {
            ...
            layouts = new int[]{
                    com.vineture.movhaul.R.layout.truck_front,
                    com.vineture.movhaul.R.layout.truck_back,
                    com.vineture.movhaul.R.layout.truck_side};
        }



        RatingBar ratingBar = (RatingBar) cell.findViewById(com.vineture.movhaul.R.id.ratingBsdar);
        RatingBar ratingBar1 = (RatingBar) cell.findViewById(com.vineture.movhaul.R.id.ratingbar);
...
*/
        ...
        DrawableCompat.setTint(DrawableCompat.wrap(layerDrawable1.getDrawable(0)),
                context.getResources().getColor(com.vineture.movhaul.R.color.light_grey));  // Empty star
        DrawableCompat.setTint(DrawableCompat.wrap(layerDrawable1.getDrawable(1)),
                context.getResources().getColor(com.vineture.movhaul.R.color.gold)); // Partial star
        DrawableCompat.setTint(DrawableCompat.wrap(layerDrawable1.getDrawable(2)),
                context.getResources().getColor(com.vineture.movhaul.R.color.gold));


        DrawableCompat.setTint(DrawableCompat.wrap(layerDrawable.getDrawable(0)),
                context.getResources().getColor(com.vineture.movhaul.R.color.shadowColor));  // Empty star
        ...
        tv_title_bidding = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_title_bidding);
        tv_title_truck = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_title_truck_type);
        tv_title_driver_name = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_title_driver_name);
        tv_title_truck_txt = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_title_truck_type_txt);
        tv_title_driver_name_txt = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_title_driver_name_txt);
        ...
        tv_content_bidding = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_content_bidding);

        tv_content_driver_name = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_content_driver_name);
        tv_content_damage_control = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_content_damage_control);
        tv_content_truck = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_content_truck_type);

        tv_content_driver_name_txt = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_content_driver_name_txt);
        tv_content_damage_control_txt = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_content_damage_control_txt);
        tv_content_truck_txt = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_content_truck_type_txt);

        tv_content_job_comp = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_content_jobs_completed);
        tv_content_break_hist = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_content_breakdown);
        tv_content_job_completed = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_content_jobs_compl);
        tv_content_break_history = (com.rey.material.widget.TextView) cell.findViewById(com.vineture.movhaul.R.id.textview_content_break);
        ...
        iv_driver_image = (ImageView) cell.findViewById(com.vineture.movhaul.R.id.driver_image);
      ...
      /*  Glide.with(ProfileActivity.this).load(Config.WEB_URL+"vehicle_details/"+img).error(R.drawable.truck_front_ico).into(iv_vec_front);
        ...
        btn_confirm = (ImageView) cell.findViewById(com.vineture.movhaul.R.id.imageView_doubletick);
        ...
        dialog2.setContentView(com.vineture.movhaul.R.layout.dialog_viewpager);

        viewPager = (ViewPager) dialog2.findViewById(com.vineture.movhaul.R.id.view_pager);
        iv_back = (ImageView) dialog2.findViewById(com.vineture.movhaul.R.id.imageview_back);
        iv_front = (ImageView) dialog2.findViewById(com.vineture.movhaul.R.id.imageview_front);
        ...
        tv_dialog1 = (TextView) dialog1.findViewById(com.vineture.movhaul.R.id.textView_1);
        tv_dialog2 = (TextView) dialog1.findViewById(com.vineture.movhaul.R.id.textView_2);
        tv_dialog3 = (TextView) dialog1.findViewById(com.vineture.movhaul.R.id.textView_3);
        tv_dialog4 = (TextView) dialog1.findViewById(com.vineture.movhaul.R.id.textView_4);
...
/*
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if(doid ==1) {
                if (position == 0) {
                    ImageView iv_trk = (ImageView) view.findViewById(com.vineture.movhaul.R.id.image);
