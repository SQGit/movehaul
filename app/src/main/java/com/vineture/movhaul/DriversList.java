...
public class DriversList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.drivers_list);
        ...
        lv_drv_list = (ListView) findViewById(com.vineture.movhaul.R.id.listview_driver);
        iv_filter = (ImageView) findViewById(com.vineture.movhaul.R.id.imgview_filter);
        lt_filter_dialog = (LinearLayout) findViewById(com.vineture.movhaul.R.id.filter_dialog);
        btn_filter = (Button) findViewById(com.vineture.movhaul.R.id.btn_filter);
        iv_close = (ImageView) findViewById(com.vineture.movhaul.R.id.button_close);
        iv_refresh = (ImageView) findViewById(com.vineture.movhaul.R.id.refresh);

        btn_back = (com.rey.material.widget.LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_back);
        btn_refresh = (com.rey.material.widget.LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_refresh);
        ...
        if (!com.vineture.movhaul.Config.isConnected(DriversList.this)) {
            snackbar.show();
        ...
        iv_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (i == 0) {
                    ...
                    iv_filter.setImageResource(com.vineture.movhaul.R.drawable.close_btn);
                    ...
                    iv_filter.setImageResource(com.vineture.movhaul.R.mipmap.ic_filter_ico);
                    i = 0;
    ...
    public class book_now_task extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                return s = HttpUtils.makeRequest1(com.vineture.movhaul.Config.WEB_URL + "customer/payment",json,id,token);
            } catch (JSONException e) {
                e.printStackTrace();
            }
            return null;
