...
public class RegisterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.register_screen);
        ...
        mProgressDialog.setTitle(getString(com.vineture.movhaul.R.string.loading));
        ...
        btn_submit = (Button) findViewById(com.vineture.movhaul.R.id.btn_submit);
        tv_register = (TextView) findViewById(com.vineture.movhaul.R.id.text_register);
        et_name = (EditText) findViewById(com.vineture.movhaul.R.id.editTextName);
        et_email = (EditText) findViewById(com.vineture.movhaul.R.id.editTextEmail);
        et_mobile = (EditText) findViewById(com.vineture.movhaul.R.id.editTextMobile);
        til_email = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_email);
        til_mobile = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_mobile);
        til_name = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_name);
                ...
                if (!(str_name.isEmpty())) {
                    if (!(str_email.isEmpty() || !android.util.Patterns.EMAIL_ADDRESS.matcher(str_email).matches())) {
                        if (!(str_mobile.isEmpty() || str_mobile.length() < 10)) {
                            ...
                            snackbar.show();
                            tv_snack.setText(com.vineture.movhaul.R.string.ent);
                            et_mobile.requestFocus();
                        }
                    } else {
                        //et_email.setError("Enter a valid email address!");
                        snackbar.show();
                        tv_snack.setText(com.vineture.movhaul.R.string.entr);
                        et_email.requestFocus();
                    }
                } else {
                   // et_name.setError("Enter a Name!");
                    snackbar.show();
                    tv_snack.setText(com.vineture.movhaul.R.string.uies);
            ...
            if (s != null) {
                try {
                    ...
                    if (status.equals("true")) {
                        ...
                        String sus_txt = getString(com.vineture.movhaul.R.string.s);
                        ...
                        if (msg.contains("customer_mobile_UNIQUE")) {
                          ...
                          //  Toast.makeText(getApplicationContext(), "Mobile Number Already Registered", Toast.LENGTH_LONG).show();
                            ...
                            snackbar.show();
                            tv_snack.setText(com.vineture.movhaul.R.string.asd);
                           ...
                           // Toast.makeText(getApplicationContext(), "Email Already Registered", Toast.LENGTH_LONG).show();
                            ...
                            snackbar.show();
                            tv_snack.setText(com.vineture.movhaul.R.string.aew);
                        }
                    }
                    ...
                    snackbar.show();
                    tv_snack.setText(com.vineture.movhaul.R.string.no_internet);
                }
            } else {
