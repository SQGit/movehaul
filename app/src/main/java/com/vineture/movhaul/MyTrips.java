...
public class MyTrips extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.mytrips);
        ...
        layouts = new int[]{
                com.vineture.movhaul.R.layout.current_trips1,
                com.vineture.movhaul.R.layout.history_trips,
                com.vineture.movhaul.R.layout.upcoming_trips,};

        viewPager = (ViewPager) findViewById(com.vineture.movhaul.R.id.view_pager);
        tiv = (TabIndicatorView) findViewById(com.vineture.movhaul.R.id.tab_indicator);
        ...
        if (!com.vineture.movhaul.Config.isConnected(MyTrips.this)) {
            snackbar.show();
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
           ...
           /*FontsManager.initFormAssets(getApplicationContext(), "fonts/lato.ttf");       //initialization
            ...
            if (position == 0) {
                ...
                tv_cr_date = (android.widget.TextView) view.findViewById(com.vineture.movhaul.R.id.cr_date);
                tv_cr_time = (android.widget.TextView) view.findViewById(com.vineture.movhaul.R.id.cr_time);
                tv_cr_pickup = (android.widget.TextView) view.findViewById(com.vineture.movhaul.R.id.cr_pickup);
                tv_cr_drop = (android.widget.TextView) view.findViewById(com.vineture.movhaul.R.id.cr_drop);
                tv_cr_tr_type = (android.widget.TextView) view.findViewById(com.vineture.movhaul.R.id.cr_truck_type);
                tv_cr_dr_name = (android.widget.TextView) view.findViewById(com.vineture.movhaul.R.id.cr_dr_name);
                tv_cr_dr_phone = (android.widget.TextView) view.findViewById(com.vineture.movhaul.R.id.cr_dr_phone);
                tv_cr_job_cost = (android.widget.TextView) view.findViewById(com.vineture.movhaul.R.id.cr_job_cost);
                iv_content_prof = (ImageView) view.findViewById(com.vineture.movhaul.R.id.imageview_content_profile);

                iv_type  = (ImageView) view.findViewById(com.vineture.movhaul.R.id.imageView5);
                ...
                if(mv_datas.getVec_type().equals("Bus")){
                    iv_type.setImageResource(com.vineture.movhaul.R.drawable.bus_type);
                }
                else{
                    iv_type.setImageResource(com.vineture.movhaul.R.drawable.select_truck_type);
                }
                ...
                ht_lview = (ListView) view.findViewById(com.vineture.movhaul.R.id.lview);
                ...
                up_lview = (android.widget.ListView) view.findViewById(com.vineture.movhaul.R.id.lview);
        ...
        public CharSequence getPageTitle(int position) {
            ...
            if (position == 0) {
                title = getString(com.vineture.movhaul.R.string.curr);
            } else if (position == 1) {
                title = getString(com.vineture.movhaul.R.string.hist);
            } else {
                title = getString(com.vineture.movhaul.R.string.upco);
            }
