...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.activity_login);
        ...
        tv_forgot_mobile = (TextView) findViewById(com.vineture.movhaul.R.id.text_forgot_no);
        et_mobile_no = (EditText) findViewById(com.vineture.movhaul.R.id.editTextMobileNo);
        flt_mobile_no = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_mobile);
        ...
        mProgressDialog = new ProgressDialog(LoginActivity.this, com.vineture.movhaul.R.style.AppCompatAlertDialogStyle);
        mProgressDialog.setTitle(getString(com.vineture.movhaul.R.string.lo));
        mProgressDialog.setMessage(getString(com.vineture.movhaul.R.string.los));
            ...
            public void onClick(View view) {
                ...
                if (!(str_mobile.isEmpty() || str_mobile.length() < 10)) {
                   ...
                   // et_mobile_no.setError("Enter valid phone number");
                    snackbar.show();
                    tv_snack.setText(com.vineture.movhaul.R.string.wa);
    ...
    public void show_wifi_not_connected() {
        ...
        if (!config.isConnected(LoginActivity.this)) {
            ...
            snack_wifi = Snackbar
                    .make(findViewById(com.vineture.movhaul.R.id.top), com.vineture.movhaul.R.string.a, Snackbar.LENGTH_INDEFINITE)
                    .setAction(com.vineture.movhaul.R.string.ae, new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                ...
                try {
                    ...
                    if (status.equals("true")) {
                        ...
                        if (msg.contains("Register with MoveHaul first to Generate OTP")) {
                            ...
                            tv_snack.setText(com.vineture.movhaul.R.string.asdw);
                            snackbar.show();
