...
public class DashboardNavigation extends FragmentActivity implements NavigationView.OnNavigationItemSelectedListener, OnMapReadyCallback, com.google.android.gms.location.LocationListener, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, MapWrapperLayout.OnDragListener {
    ...
    private void insertDummyContactWrapper() {
        ...
        if (permissionsList.size() > 0) {
            if (permissionsNeeded.size() > 0) {
                // Need Rationale
                String message = getString(com.vineture.movhaul.R.string.ees) + permissionsNeeded.get(0);
        ...
        switch (requestCode) {
            case REQUEST_CODE_ASK_MULTIPLE_PERMISSIONS: {
                ...
                if (perms.get(Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
                    ...
                    Toast.makeText(DashboardNavigation.this, com.vineture.movhaul.R.string.permis_si, Toast.LENGTH_SHORT)
                            .show();
                }
            }
            break;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.activity_dashboard);
        ...
        drawer = (DrawerLayout) findViewById(com.vineture.movhaul.R.id.drawer_layout);
        navigationView = (NavigationView) findViewById(com.vineture.movhaul.R.id.nav_view);
        btn_book_now = (Button) findViewById(com.vineture.movhaul.R.id.btn_book_now);
        btn_book_later = (Button) findViewById(com.vineture.movhaul.R.id.btn_book_later);
        tv_name = (TextView) findViewById(com.vineture.movhaul.R.id.textView_name);
        tv_email = (TextView) findViewById(com.vineture.movhaul.R.id.textView_email);
        tv_myTrips = (TextView) findViewById(com.vineture.movhaul.R.id.textView_mytrips);
        tv_jobReview = (TextView) findViewById(com.vineture.movhaul.R.id.textView_jobreview);
        tv_payments = (TextView) findViewById(com.vineture.movhaul.R.id.textView_payments);
        tv_tracking = (TextView) findViewById(com.vineture.movhaul.R.id.textView_tracking);
        tv_offers = (TextView) findViewById(com.vineture.movhaul.R.id.textView_offers);
        tv_emergencyContacts = (TextView) findViewById(com.vineture.movhaul.R.id.textView_emergencycontacts);
        aet_pickup = (AutoCompleteTextView) findViewById(com.vineture.movhaul.R.id.editText_pickUp);
        aet_drop = (AutoCompleteTextView) findViewById(com.vineture.movhaul.R.id.editText_dropLocation);
        flt_pickup = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_pickup);
        flt_drop_location = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_drop);
        lt_drop = (android.widget.LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_drop);
        lt_pickup = (android.widget.LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_pickuptype);
        btn_menu = (ImageView) findViewById(com.vineture.movhaul.R.id.img_menu);
        rightmenu = (ImageView) findViewById(com.vineture.movhaul.R.id.right_menu);
        toolbar = (Toolbar) findViewById(com.vineture.movhaul.R.id.toolbar);
        lt_first = (LinearLayout) findViewById(com.vineture.movhaul.R.id.first);
        lt_second = (FrameLayout) findViewById(com.vineture.movhaul.R.id.second);
        lt_last = (LinearLayout) findViewById(com.vineture.movhaul.R.id.bottom_layout);
        lt_frame = (FrameLayout) findViewById(com.vineture.movhaul.R.id.frame);
        btn_editProfile = (ImageView) findViewById(com.vineture.movhaul.R.id.imageView2);
        btn_editProfile_img = (ImageView) findViewById(com.vineture.movhaul.R.id.imageView);

        iv_location = (ImageView) findViewById(com.vineture.movhaul.R.id.imageview_location);

        fl_bottom_frame = (android.widget.RelativeLayout) findViewById(com.vineture.movhaul.R.id.bottom_frame_layout);
        lt_top = (LinearLayout) findViewById(com.vineture.movhaul.R.id.top_layout);
        iv_map_point = (ImageView) findViewById(com.vineture.movhaul.R.id.map_point);
        ...
        bottomSheetViewgroup
                = (android.widget.RelativeLayout) findViewById(com.vineture.movhaul.R.id.bottom_sheet);
        ...
        lt_bt_veh_type = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_vehicle_type);
        lt_bt_tow_type = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_tow_type);

        lt_bt_tow_type.setVisibility(View.GONE);

        lt_bt_veh_car = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_bt_car);
        lt_bt_veh_truck = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_bt_truck);
        lt_bt_veh_bus = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_bt_bus);

        lt_bt_veh_tow = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_bt_tow);
        lt_bt_veh_flatbed = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_bt_flatbed);


        Log.e("tag", "ss:" + bottomSheetBehavior.getState());

        btn_book_roadside = (Button) findViewById(com.vineture.movhaul.R.id.btn_book_assistance);
        ...
        customMapFragment = ((CustomMapFragment) getSupportFragmentManager().findFragmentById(com.vineture.movhaul.R.id.map));
        ...
        lt_filter_dialog = (LinearLayout) findViewById(com.vineture.movhaul.R.id.filter_dialog);
        ...
        iv_truck = (ImageView) findViewById(com.vineture.movhaul.R.id.image_truck);
        iv_bus = (ImageView) findViewById(com.vineture.movhaul.R.id.image_bus);
        iv_road_assit = (ImageView) findViewById(com.vineture.movhaul.R.id.image_roadside_assistance);

        mProgressDialog = new ProgressDialog(DashboardNavigation.this, com.vineture.movhaul.R.style.AppCompatAlertDialogStyle);
        mProgressDialog.setTitle(com.vineture.movhaul.R.string.loading);
        mProgressDialog.setMessage(getString(com.vineture.movhaul.R.string.wait));
        ...
        iv_zoomin = (ImageView) findViewById(com.vineture.movhaul.R.id.zoomin);
        iv_zoomout = (ImageView) findViewById(com.vineture.movhaul.R.id.zoomout);
        ...
        snackbar = Snackbar
                .make(findViewById(com.vineture.movhaul.R.id.top), com.vineture.movhaul.R.string.no_internet, Snackbar.LENGTH_SHORT);
        ...
        snackbar_loc = Snackbar
                .make(findViewById(com.vineture.movhaul.R.id.cd_layout), com.vineture.movhaul.R.string.loc, Snackbar.LENGTH_INDEFINITE)
                .setAction(com.vineture.movhaul.R.string.open_settings, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
        ...
        if (checkPlayServices()) {
            ...
            snackbar.show();
            tv_snack.setText(com.vineture.movhaul.R.string.alocl);
        }
        ...
        final ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, com.vineture.movhaul.R.string.app_name, com.vineture.movhaul.R.string.app_name)
            ...
            public void onDrawerStateChanged(int newState) {
                if (newState == DrawerLayout.STATE_SETTLING ) {
                    ...
                    if(fl_bottom_frame.getVisibility() == View.GONE) {
                        ...
                        int valueInPixels = (int) getResources().getDimension(com.vineture.movhaul.R.dimen._70sdp);
        ...
        dialog2.setContentView(com.vineture.movhaul.R.layout.dialogue_profile);
        btn_update = (Button) dialog2.findViewById(com.vineture.movhaul.R.id.button_update);
        btn_close = (ImageView) dialog2.findViewById(com.vineture.movhaul.R.id.button_close);
        et_username = (EditText) dialog2.findViewById(com.vineture.movhaul.R.id.editTextName);
        et_email = (EditText) dialog2.findViewById(com.vineture.movhaul.R.id.editTextEmail);
        flt_uname = (TextInputLayout) dialog2.findViewById(com.vineture.movhaul.R.id.float_name);
        flt_email = (TextInputLayout) dialog2.findViewById(com.vineture.movhaul.R.id.float_email);
            ...
            public void onClick(View view) {
                if (!(et_username.getText().toString().isEmpty())) {
                    if (!(et_email.getText().toString().isEmpty())) {
                        ...
                        Toast.makeText(getApplicationContext(), com.vineture.movhaul.R.string.aec, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(getApplicationContext(), com.vineture.movhaul.R.string.aes, Toast.LENGTH_SHORT).show();
                }
                dialog2.dismiss();
            }
        });
        ...
        dialog1.setContentView(com.vineture.movhaul.R.layout.dialog_yes_no);
        btn_yes = (Button) dialog1.findViewById(com.vineture.movhaul.R.id.button_yes);
        btn_no = (Button) dialog1.findViewById(com.vineture.movhaul.R.id.button_no);

        tv_txt1 = (android.widget.TextView) dialog1.findViewById(com.vineture.movhaul.R.id.textView_1);
        tv_txt2 = (android.widget.TextView) dialog1.findViewById(com.vineture.movhaul.R.id.textView_2);
        tv_txt3 = (android.widget.TextView) dialog1.findViewById(com.vineture.movhaul.R.id.textView_3);
        ...
        btn_editProfile_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* PhotoPickerIntent intent = new PhotoPickerIntent(DashboardNavigation.this);
                ...
                config.setCameraHeight(com.vineture.movhaul.R.dimen.app_camera_height);

                config.setCameraBtnBackground(com.vineture.movhaul.R.drawable.round_dr_red);

                config.setToolbarTitleRes(com.vineture.movhaul.R.string.custom_title);
                config.setSelectedBottomHeight(com.vineture.movhaul.R.dimen.bottom_height);
        ...
        rightmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                popup.getMenuInflater().inflate(com.vineture.movhaul.R.menu.menu, popup.getMenu());
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case com.vineture.movhaul.R.id.support: {
                            ...
                            case com.vineture.movhaul.R.id.feedback: {
                                return true;
                            }
                            case com.vineture.movhaul.R.id.logout: {
                                dialog1.show();
                                exit_status = 0;
                                tv_txt3.setText(com.vineture.movhaul.R.string.asdew);
                                return true;
                            }
                            default: {
                                return true;
...
*//*
            ...
            public void onClick(View view) {
                ...
                if (diff >= 0) {
                    ...
                    if (aet_drop.getText().toString().isEmpty()) {
                        ...
                        snackbar.show();
                        tv_snack.setText(com.vineture.movhaul.R.string.adsfb);
                    } else {
                    ...
                    snackbar.show();
                    tv_snack.setText(com.vineture.movhaul.R.string.asdf);
                }
            ...
            public void onClick(View view) {
             /*   Intent i = new Intent(DashboardNavigation.this, Book_later.class);
                ...
                if (aet_drop.getText().toString().isEmpty()) {
                    // Toast.makeText(getApplicationContext(), "Choose Drop Location", Toast.LENGTH_LONG).show();
                    snackbar.show();
                    tv_snack.setText(com.vineture.movhaul.R.string.aewas);
                } else {
                    editor.putString("pickup", mStreetOutput + ", " + mCityOutput);
                    editor.putString("drop", aet_drop.getText().toString());
                    editor.putString("pickup_lati", mPickup_lat);
        ...
        dg_road_confirm.setContentView(com.vineture.movhaul.R.layout.dialog_road_confirm);

        btn_yes = (Button) dg_road_confirm.findViewById(com.vineture.movhaul.R.id.button_yes);
        tv_txt1 = (android.widget.TextView) dg_road_confirm.findViewById(com.vineture.movhaul.R.id.textView_1);
        tv_txt2 = (android.widget.TextView) dg_road_confirm.findViewById(com.vineture.movhaul.R.id.textView_2);
        ...
        btn_book_roadside.setOnClickListener(new View.OnClickListener() {
            ...
            /*    Intent intent = new Intent(DashboardNavigation.this, RemitaMainActivity.class);
                ...
                if (aet_drop.getText().toString().isEmpty()) {
                    snackbar.show();
                    tv_snack.setText(com.vineture.movhaul.R.string.drpa);
                } else {
    ...
    protected void onRestart() {
        ...
        if (checkPlayServices()) {
            ...
            snackbar.show();
            tv_snack.setText(com.vineture.movhaul.R.string.asdloc);
        }
    ...
    private void openAutocompleteActivity() {
        try {
         ...
         //   AutocompleteFilter typeFilter = new AutocompleteFilter.Builder().setTypeFilter(Place.TYPE_COUNTRY).setCountry("US").build();
            ...
            // resolvable.
            String message = getString(com.vineture.movhaul.R.string.goglso) +
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                ...
                //finish();
                snackbar.show();
                tv_snack.setText(com.vineture.movhaul.R.string.google_play);
            }
            return false;
        }
        return true;
        ...
        if((aet_pickup.getText().toString().isEmpty())) {
            if (mMap != null) {
                ...
                Toast.makeText(getApplicationContext(),
                        com.vineture.movhaul.R.string.unabs, Toast.LENGTH_SHORT)
                        .show();
            }
        }
    ...
    public void onBackPressed() {
        if (lt_filter_dialog.getVisibility() == View.VISIBLE) {
            dialog1.show();
            exit_status = 1;
            tv_txt3.setText(com.vineture.movhaul.R.string.ext);
        } else {
            final int height = getDeviceHeight(DashboardNavigation.this);
            TranslateAnimation anim_btn_b2t = new TranslateAnimation(0, 0, height, 0);
            anim_btn_b2t.setDuration(500);
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            if (!result.isEmpty()) {
                for (int i = 0; i < result.size(); i++) {
                    ...
                    lineOptions.width(6);
                    lineOptions.color(getResources().getColor(com.vineture.movhaul.R.color.redColor));
        ...
        protected String doInBackground(String... strings) {
            ...
            if (selectedPhotos.size() > 0) {
                ...
                try {
                    ...
                    return s = HttpUtils.makeRequest1(com.vineture.movhaul.Config.WEB_URL + "customer/customerupdate", json, id, token);
            ...
            if (s != null) {
                try {
                    ...
                    if (status.equals("true")) {
                        ...
                        Toast.makeText(getApplicationContext(), com.vineture.movhaul.R.string.asder, Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(String s) {
            ...
            if (s != null) {
                try {
                    ...
                    e.printStackTrace();
                    Log.e("tag", "nt" + e.toString());
                    Toast.makeText(getApplicationContext(), com.vineture.movhaul.R.string.ase, Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(getApplicationContext(), com.vineture.movhaul.R.string.aese, Toast.LENGTH_LONG).show();
            }
    ...
    public class book_roadside extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                return s = HttpUtils.makeRequest1(com.vineture.movhaul.Config.WEB_URL + "customer/emergencybooking", json, id, token);
            } catch (JSONException e) {
                e.printStackTrace();
            }
            return null;
            ...
            if (s != null) {
                try {
                    ...
                    if (status.equals("true")) {
                        ...
                        Toast.makeText(getApplicationContext(), com.vineture.movhaul.R.string.eer, Toast.LENGTH_LONG).show();

                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.e("tag", "nt" + e.toString());
                    Toast.makeText(getApplicationContext(), com.vineture.movhaul.R.string.era, Toast.LENGTH_LONG).show();
                }
            } else {
                // Toast.makeText(getApplicationContext(),"Network Errror1",Toast.LENGTH_LONG).show();
            }
    ...
    public class book_now_task extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                return s = HttpUtils.makeRequest1(com.vineture.movhaul.Config.WEB_URL + "customer/emergencypayment", json, id, token);
            } catch (JSONException e) {
                e.printStackTrace();
            }
            return null;
