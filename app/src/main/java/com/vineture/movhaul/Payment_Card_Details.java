...
public class Payment_Card_Details extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.payment_carddetails);
        FontsManager.initFormAssets(this, "fonts/lato.ttf");       //initialization
        FontsManager.changeFonts(this);
        btn_paynow = (Button) findViewById(com.vineture.movhaul.R.id.btn_paynow);
        btn_back = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_back);
        flt_exp_date = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_exp_date);
        flt_cvv = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_cvv);
        flt_name = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_name);
