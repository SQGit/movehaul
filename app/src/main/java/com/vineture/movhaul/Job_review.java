...
public class Job_review extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.job_review);
        ...
        btn_continue = (Button) findViewById(com.vineture.movhaul.R.id.btn_continue);
        tv_timer = (TextView) findViewById(com.vineture.movhaul.R.id.text_Timer);

        tv_pickup = (TextView) findViewById(com.vineture.movhaul.R.id.textview_pickup);
        tv_drop = (TextView) findViewById(com.vineture.movhaul.R.id.textview_drop);
        tv_delivery = (TextView) findViewById(com.vineture.movhaul.R.id.textview_delivery);
        tv_date = (TextView) findViewById(com.vineture.movhaul.R.id.textview_date);
        tv_time = (TextView) findViewById(com.vineture.movhaul.R.id.textview_time);
        tv_truck = (TextView) findViewById(com.vineture.movhaul.R.id.textview_truck);
        iv_type  = (ImageView) findViewById(com.vineture.movhaul.R.id.image_type);

        lt_nearby = (android.widget.LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_landmark);

        tv_da_header = (TextView) findViewById(com.vineture.movhaul.R.id.textview_da_header);
        ...
        if (!com.vineture.movhaul.Config.isConnected(Job_review.this)) {
            snackbar.show();
        ...
        new CountDownTimer(20000, 1000) { // adjust the milli seconds here
            ...
            public void onFinish() {
                //onClickVibrate();
                tv_timer.setText(com.vineture.movhaul.R.string.dons);
