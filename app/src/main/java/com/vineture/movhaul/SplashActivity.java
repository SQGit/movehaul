...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.splash_screen);
        ...
        lt_top = (LinearLayout) findViewById(com.vineture.movhaul.R.id.top);
        btn_register = (Button) findViewById(com.vineture.movhaul.R.id.btn_register);
        btn_login = (Button) findViewById(com.vineture.movhaul.R.id.btn_login);
        truck_icon = (ImageView) findViewById(com.vineture.movhaul.R.id.truck_icon);
        bg_icon = (ImageView) findViewById(com.vineture.movhaul.R.id.bg_icon);
        logo_icon = (ImageView) findViewById(com.vineture.movhaul.R.id.logo_ico);
        lt_bottom = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_bottom);

        btn_call = (Button) findViewById(com.vineture.movhaul.R.id.button_call);
        btn_call.setVisibility(View.GONE);

        snackbar = Snackbar.make(lt_top, com.vineture.movhaul.R.string.no_internet, Snackbar.LENGTH_INDEFINITE)
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Bundle bndlanimation =
                                ActivityOptions.makeCustomAnimation(getApplicationContext(), com.vineture.movhaul.R.anim.anim1, com.vineture.movhaul.R.anim.anim2).toBundle();
