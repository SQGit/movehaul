...
public class Forgot_Mobile extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.forgot_phone);
        FontsManager.initFormAssets(this, "fonts/lato.ttf");       //initialization
        FontsManager.changeFonts(this);

        flt_email = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_email);
        btn_back = (LinearLayout) findViewById(com.vineture.movhaul.R.id.layout_back);
        edtxt_email = (EditText) findViewById(com.vineture.movhaul.R.id.editTextEmail);
