...
public class HistoryAdapter extends BaseAdapter {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(com.vineture.movhaul.R.layout.history_adapter, viewGroup, false);
            mViewHolder = new MyViewHolder(convertView);

           id = (com.rey.material.widget.TextView) convertView.findViewById(com.vineture.movhaul.R.id.textview_book_id);
           date = (com.rey.material.widget.TextView) convertView.findViewById(com.vineture.movhaul.R.id.textview_date);
            id.setTypeface(tf);
            date.setTypeface(tf);
