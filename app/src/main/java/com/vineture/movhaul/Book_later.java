...
public class Book_later extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vineture.movhaul.R.layout.book_later);
        FontsManager.initFormAssets(this, "fonts/lato.ttf");       //initialization
        FontsManager.changeFonts(this);
        type = Typeface.createFromAsset(getAssets(), "fonts/lato.ttf");
        mdatas = new ArrayList<>();
        btn_time = (ImageView) findViewById(com.vineture.movhaul.R.id.iv_btn_time);
        btn_date = (ImageView) findViewById(com.vineture.movhaul.R.id.iv_btn_date);
        // msg=(TextView) findViewById(R.id.msg);
        mSelectedImagesContainer = (ViewGroup) findViewById(com.vineture.movhaul.R.id.selected_photos_container);
        et_time = (EditText) findViewById(com.vineture.movhaul.R.id.editTextTime);
        et_goodsType = (EditText) findViewById(com.vineture.movhaul.R.id.editTextGoodsType);
        et_date = (EditText) findViewById(com.vineture.movhaul.R.id.editTextDate);
        et_truckType = (EditText) findViewById(com.vineture.movhaul.R.id.editTextTruck_type);
        et_deliveryAddress = (EditText) findViewById(com.vineture.movhaul.R.id.editTextDelieveryAddress);
        ...
        flt_date = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_date);
        flt_time = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_time);
        ...
        flt_deliveryAddress = (TextInputLayout) findViewById(com.vineture.movhaul.R.id.float_deliveryaddress);
        ...
        snackbar = Snackbar
                .make(findViewById(com.vineture.movhaul.R.id.top), "Network Error! Please Try Again Later.", Snackbar.LENGTH_LONG);
        ...
        mProgressDialog = new ProgressDialog(Book_later.this, com.vineture.movhaul.R.style.AppCompatAlertDialogStyle);
        ...
        if (!com.vineture.movhaul.Config.isConnected(Book_later.this)) {
            snackbar.show();
