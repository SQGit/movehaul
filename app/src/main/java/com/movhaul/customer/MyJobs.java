 ...
 * shows list of jobs placd by customer.
 */
public class MyJobs extends Activity {
    ...
    @SuppressWarnings({"unused", "UnusedAssignment", "unchecked"})
    private class get_job_lists extends AsyncTask<String, Void, String> {
        @Override
