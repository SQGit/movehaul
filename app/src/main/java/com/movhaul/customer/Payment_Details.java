 ...
 * payment page
 * contains remita,paystack
 * remita for online banking accounts
...
public class Payment_Details extends Activity {
    ...
    ImageView btn_close;
    Typeface tf;
    TextView tv_dialog1, tv_dialog2, tv_dialog3;
    Snackbar snackbar;
    EditText et_card1, et_card2, et_card3, et_card4, et_exp, et_cvv;
    TextView tv_snack;
    boolean bl_truck;
    ...
    private RadioButton r_card, bank;
