 ...
 * vehicle type
 */
class Dialog_VehicleType extends Dialog {
    public Activity activity;
    Typeface tf;
    private ArrayList<String> aaaa = new ArrayList<>();
    private ArrayList<String> ar_sub_type = new ArrayList<>();
    private ListAdapter adapter2;
    Context context;
    SharedPreferences sharedPreferences;
    SharedPreferences.Editor editor;
    private ArrayList<String> ar_truck_type = new ArrayList<>();
    private HashMap<String, String> hash_subtype = new HashMap<>();
    private ImageView image;
    private ArrayList<String> ar_truck_imgs = new ArrayList<>();
    private ArrayList<String> ar_truck_iimgs;
   ...
   // private WrappingViewPager viewpager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.movhaul.customer.R.layout.dialog_vehicletype);
        android.widget.RelativeLayout rll = (android.widget.RelativeLayout) findViewById(R.id.rl);
        tf = Typeface.createFromAsset(activity.getAssets(), "fonts/lato.ttf");
        layouts = new int[]{
                com.movhaul.customer.R.layout.register_country,
                com.movhaul.customer.R.layout.register_state,
        };
    ...
    private class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (position == 0) {
                ...
                lview_cont = (ListView) view.findViewById(com.movhaul.customer.R.id.lview);
                ListAdapter adapter1 = new ListAdapter(activity.getApplicationContext(), R.layout.dialog_truck_type, ar_truck_types, 0);
                lview_cont.setAdapter(adapter1);
            } else {
                Log.e("tag","from_pager");
                lview_state = (ListView) view.findViewById(com.movhaul.customer.R.id.lview);
                adapter2 = new ListAdapter(activity.getApplicationContext(), com.movhaul.customer.R.layout.dialog_vehicle_types, ar_sub_type,1);
    ...
    private class ListAdapter extends ArrayAdapter<String> {
        ...
        int page;
        View div_view;
        ListAdapter(Context context, int textViewResourceId, ArrayList<String> objects, int page) {
        ...
        View getCustomView(int posi, View row, ViewGroup parent) {
            ...
            if(page==0) {
                ImageView iv_truck_ico = (ImageView) arow.findViewById(R.id.image_icon);
                ...
                image = (ImageView) arow.findViewById(com.movhaul.customer.R.id.image);
            }
            if(page ==0){
