...
public class Dialog_VehicleType extends Dialog {
   ...
   // private WrappingViewPager viewpager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rll = (android.widget.RelativeLayout) findViewById(com.movhaul.customer.R.id.rl);
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (position == 0) {
                ...
                adapter1 = new ListAdapter(activity.getApplicationContext(), com.movhaul.customer.R.layout.dialog_truck_type, ar_truck_types,0);
